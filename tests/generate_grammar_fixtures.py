...
REPRESENTATIVE_FILE_NAME = "031222-401-03-Dec-2022-1.pkl"
HAS_REPRESENTATIVE_GRAMMAR_INPUTS = (
    (STRATEGY_SEQUENCE_DIR / REPRESENTATIVE_FILE_NAME).is_file()
    and (STATE_GRAPH_DIR / REPRESENTATIVE_FILE_NAME).is_file()
)
